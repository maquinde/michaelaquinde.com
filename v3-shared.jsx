...
(function () {
  ...
  const AUDIO = {
    ...
    ep3: "https://github.com/maquinde/michaelaquinde.com/releases/download/podcast-audio/Practical_Cloud_Security.m4a",
  };
  ...
  const BUY = {
    ...
    ep3: "https://www.amazon.com/dp/1098148177?tag=magk0e-20",
  };

  const EPISODES = [
    { num: 3, title: "Practical Cloud Security: A Guide for Secure Design and Deployment", guest: "NotebookLM Speaker", date: "07.18.26", duration: 0, src: AUDIO.ep3, cover: "covers/ep003-practical-cloud-security.png", desc: "Chris Dotson lays out a vendor-neutral framework for securing cloud environments, walking through the full lifecycle from data classification and identity and access management to encryption, network segmentation, and incident response. Rather than treating cloud security as an extension of on-premises practice, the book reframes it around the shared responsibility model, showing engineers and architects how to reason about risk consistently across AWS, Azure, and Google Cloud. Practical checklists and real-world examples anchor each chapter, making the case that secure-by-design cloud architecture is achievable without slowing teams down.", buy: BUY.ep3 },
